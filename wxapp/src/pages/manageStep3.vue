  ...
  <div class="main">
    ...
    <div class="container">
        ...
        <div class="cont_wrap">
          ...
          <div class="image">
            <div :style="{'opacity':showQrImage}" class="absolute">
              <image :src="url" @error="onloadError" @load="onloadComplete" lazy-load="true" mode="scaleToFill" />
            </div>
      ...
      <div class="out-desc-wrap">
        <div class="desc">
          ...
          <div class="row">
            ...
            <span>注册成功后，保安用此工具扫住户通行证，并查验身份，确定“放行”还是“劝返”。</span>
          </div>
        </div>
      </div>
      <div class="button_wrap">
        ...
        <button :class="{'disabled': !canNextStep}" @tap="nextStep" class="panel deal-btn">
          <span class="text">下一步（3/3）</span>
        </button>
      </div>
    </div>
